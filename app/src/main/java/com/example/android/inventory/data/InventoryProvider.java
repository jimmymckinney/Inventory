...
public class InventoryProvider extends ContentProvider {
    ...
    private Uri insertProduct(Uri uri, ContentValues values) {
        ...
        //Check that product quantity is not null and has a valid quantity
        Integer productQuantity = values.getAsInteger(InventoryEntry.COLUMN_PRODUCT_QUANTITY);
        Log.v("insertProduct", productQuantity.toString());
    ...
    public int update(Uri uri, ContentValues contentValues, String selection,
        ...
        // Notify all listeners that the data has changed for the invenotory content URI
    }
